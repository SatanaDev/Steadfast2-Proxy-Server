...
$phar->setStub('<?php define("proxy\\\\PATH", "phar://". __FILE__ ."/"); require_once("phar://". __FILE__ ."/src/proxy/Proxy.php");  __HALT_COMPILER();');
...
foreach (new \RecursiveIteratorIterator(new \RecursiveDirectoryIterator($filePath . "src")) as $file) {
	...
	if ($path{0} === "." or strpos($path, "/.") !== false or substr($path, 0, 9) !== "src/") {
		continue;
	}
